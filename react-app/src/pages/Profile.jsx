...
export default function Profile() {
  const dummyPosts = [
    {
      ...
      time: 'Just now',
      title: 'Update on the new Facebook clone features! 🚀',
  ...
  return (
    <div className="th-layout" style={{ paddingTop: '56px', background: 'var(--primary-bg)' }}>
        ...
        <div className="container" style={{ maxWidth: '1095px', padding: 0 }}>
          <div className="th-cover-photo-container">
            <div className="th-cover-photo" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070&auto=format&fit=crop)' }}>
              <button className="th-edit-cover-btn">
          ...
          <div className="th-profile-info-container">
            <div className="th-profile-avatar-wrapper">
              ...
              <button className="th-edit-avatar-btn">
            ...
            <div className="th-profile-details">
              ...
              <div className="th-profile-actions">
                <button className="th-btn-primary" style={{ padding: '8px 12px' }}>
                  <i className="bi bi-plus-circle-fill me-1"></i> Add to story
                </button>
                <button className="th-btn-secondary" style={{ padding: '8px 12px' }}>
                  <i className="bi bi-pencil-fill me-1"></i> Edit profile
                </button>
                <button className="th-btn-secondary px-3" style={{ padding: '8px 12px' }}>
          ...
          <div className="th-profile-nav">
            <button className="th-profile-nav-btn active">Posts</button>
            <button className="th-profile-nav-btn">About</button>
            <button className="th-profile-nav-btn">Friends</button>
            <button className="th-profile-nav-btn">Photos</button>
            <button className="th-profile-nav-btn">Videos</button>
            <button className="th-profile-nav-btn">Reels</button>
            <button className="th-profile-nav-btn">More <i className="bi bi-caret-down-fill ms-1"></i></button>
            <div style={{flex: 1}}></div>
            <button className="th-btn-secondary px-3" style={{ padding: '8px 12px' }}><i className="bi bi-three-dots"></i></button>
          </div>
        </div>
      </div>
          ...
          <div className="row mt-3">
            <div className="col-lg-5 col-12 mb-3">
              <div className="th-card th-intro-card mb-3">
                ...
                <button className="th-btn-secondary w-100 mb-3" style={{ padding: '8px' }}>Edit bio</button>
                
                <div className="th-intro-item">
                  <i className="bi bi-briefcase-fill text-muted"></i>
                  <span>Software Engineer at <strong>TechHub</strong></span>
                </div>
                <div className="th-intro-item">
                  <i className="bi bi-mortarboard-fill text-muted"></i>
                  <span>Studied Computer Science at <strong>University of Tech</strong></span>
                </div>
                <div className="th-intro-item">
                  <i className="bi bi-house-door-fill text-muted"></i>
                  <span>Lives in <strong>San Francisco, California</strong></span>
                </div>
                <div className="th-intro-item">
                  <i className="bi bi-geo-alt-fill text-muted"></i>
                  <span>From <strong>New York, New York</strong></span>
                </div>
                <div className="th-intro-item">
                  <i className="bi bi-heart-fill text-muted"></i>
                  <span>Single</span>
                </div>
                <button className="th-btn-secondary w-100 mt-3" style={{ padding: '8px' }}>Edit details</button>
                <button className="th-btn-secondary w-100 mt-2" style={{ padding: '8px' }}>Add hobbies</button>
                <button className="th-btn-secondary w-100 mt-2" style={{ padding: '8px' }}>Add featured</button>
              </div>

              <div className="th-card th-intro-card mb-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h3 className="th-card-title mb-0">Photos</h3>
                  <button className="btn btn-link text-decoration-none p-0" style={{ color: 'var(--accent-blue)' }}>See all photos</button>
                </div>
              ...
              <div className="th-card th-intro-card">
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <div>
                    ...
                    <div className="text-muted" style={{fontSize: '0.9375rem'}}>1,245 friends</div>
                  </div>
                  <button className="btn btn-link text-decoration-none p-0" style={{ color: 'var(--accent-blue)' }}>See all friends</button>
                </div>
                <div className="th-friends-grid mt-3">
                  {[
                    {name: 'Jack', seed: 'Jack'}, {name: 'Sarah', seed: 'Sarah'}, {name: 'Mike', seed: 'Mike'},
                    {name: 'Emma', seed: 'Emma'}, {name: 'John', seed: 'John'}, {name: 'Lisa', seed: 'Lisa'}
                  ].map((f, i) => (
            ...
            <div className="col-lg-7 col-12">
              ...
              <div className="th-card p-3 d-flex justify-content-between align-items-center mb-3">
                <h3 className="th-card-title mb-0" style={{ fontSize: '1.25rem' }}>Posts</h3>
                <div className="d-flex gap-2">
                  <button className="th-btn-secondary" style={{ padding: '6px 12px' }}><i className="bi bi-sliders"></i> Filters</button>
                  <button className="th-btn-secondary" style={{ padding: '6px 12px' }}><i className="bi bi-gear-fill"></i> Manage posts</button>
                </div>
              </div>

              {dummyPosts.map(post => (
                <PostCard key={post.id} post={post} onLike={() => {}} onShare={() => {}} />
              ))}
            </div>
          </div>
        </div>
